/**
 * This program implements a basic Binary Search Tree (BST) with functionality for:
 * creation, insertion, deletion, traversal, size checking, and searching.
 * It uses recursion and pointer-based tree structure management.
 * 
 * Author: Ben
 * Date: 2024-09
 * 
