...
typedef int (*action_func_sll_t)(void *data, void *param);
typedef int (*match_func_sll_t)(const void *data, void *param);
...
slist_iter_t SListFind(slist_iter_t from,
                        slist_iter_t to,
                        match_func_sll_t is_match_func,
                        void *param);
...
int SListForEach(slist_iter_t from,
                 slist_iter_t to,
                 action_func_sll_t action_func, void *param);
